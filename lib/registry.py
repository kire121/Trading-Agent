...
#
# METUSALEM-NOT (AVVIKELSER.md sec.2): denna fil + registry/ytor.jsonl
# existerar identiskt pa tva omergade branches (claude/timglaset-levande-
# komponenter-g8v0j3 och claude/flodmarket-levande-komponenter-ksn11a) men
# pa INGENDERA av dem i main -- bekraftat via `git branch -a --contains
# <flodmarket-registerkonsolideringscommit>`, som visar main saknar den
# commiten trots dess eget committmeddelande ("Konsolidera registret till
# main..."). Denna sessions branch-mandat tillater bara push till den egna
# strategigrenen, inte till main, sa "merga registret till main om
# trivialt" (spec S1, registerfragmenteringsstycket) kan inte utforas har.
# Foljer istallet spec S1:s egen uttryckliga fallback: Flodmarket-monstret
# (kopiera denna fil oforandrad + registry/ytor.jsonl hit, logga avvikelsen).
# Kopian ar BYTE-IDENTISK mellan de tva kallbranscherna (diff kord, ingen
# skillnad) -- inget val mellan divergerande versioner behovdes.
